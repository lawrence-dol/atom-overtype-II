...
Others:
    ...
    description: """
        This package depends on several other packages. All of them belong to Atom and are built-ins. Some settings of
        these may cause glitches or surprising behavior. You may adjust the options here or in the respective
        package-views.<br/> This pkg depends on **atom-status-bar**, **line-ending-selector**, **settings-view** and
        supports *autocomplete-plus* and *bracket-matcher*.
        """
    type: 'object'
    properties:
        autocompletePlus:
